...
## Risk Signals
**Impossible travel** uses 5 layered signals: pairwise geo-velocity against recent login history, country rarity (user-level and population-level), device-location mismatch scoring, and geo-session continuity analysis — matching the approach used by enterprise identity platforms.
